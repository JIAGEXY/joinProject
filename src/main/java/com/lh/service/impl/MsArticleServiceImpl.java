...
public class MsArticleServiceImpl implements MsArticleService {
    ...
    public R publisharticles(Long artid,Long lableid, String title,String imgurl,String txturl) {
        ...
        if(artid!=0){
            try {
                ...
                String filename1 = txt.substring(txt.lastIndexOf("M00"));
            ...
            msArtLable.setArtid(msArticle.getArtid());
    ...
    public MsArticleDto selectone(Long artId) {
        ...
        msArticleDto.setHeadphoto(msUser.getHeadphoto());
